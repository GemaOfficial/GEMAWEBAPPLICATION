...
function Location() {
  return (
    ...
    >
      ...
      />
      <path
        d="M12.0001 13.46C13.7398 13.46 15.1501 12.0497 15.1501 10.31C15.1501 8.5703 13.7398 7.16 12.0001 7.16C10.2604 7.16 8.8501 8.5703 8.8501 10.31C8.8501 12.0497 10.2604 13.46 12.0001 13.46Z"
        fill="white"
      />
    </svg>
  );
